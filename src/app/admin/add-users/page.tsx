...
const Page = () => {
  ...
  const [isPendingAddUser, startTransitionAddUser] = useTransition(); // For Add User form
const [isPendingAssignTask, startTransitionAssignTask] = useTransition(); // For Assign Task modal
  ...
  const handleAssignTaskSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    e.stopPropagation();
    startTransitionAssignTask(async () => {
      try {
      ...
      <div className="bg-white rounded-[10px] w-full p-5">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-[30px] flex justify-end ">
            <button type="submit" className="button px-[30px]" disabled={isPendingAddUser}>
              {isPendingAddUser ? 'Submitting...' : 'Submit'}<ButtonArrow />
            </button>
          </div>
        </form>
      </div>
          ...
          <div className="p-3">
            ...
            <form onSubmit={handleAssignTaskSubmit}>
              ...
              <div className="flex justify-end mt-4">
                ...
                > {isPendingAssignTask ? 'Submitting...' : 'Submit'}<ButtonArrow /></button>
