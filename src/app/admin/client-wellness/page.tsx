"use client";
import React, { useState, ChangeEvent, FormEvent, useTransition, useRef } from "react";
      ...
      <div className="mt-[50px]">
                ...
                clientsTrainingData?.map((row: any) => (
                  <tr key={row?._id}>
                    ...
                    <td className="capitalize">
                      {row?.assignedToId ? row?.assignedToId?.firstName + ' ' + row?.assignedToId?.lastName : row?.assignTo}
                    </td>
                    <td>
                      <Link
                        href={getImageUrlOfS3(row?.attachment) ?? ""}
                        target="_blank"
        ...
        >
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="text-[#283C63] font-bold text-[20px] text-center leading-normal mt-[-20px]">
