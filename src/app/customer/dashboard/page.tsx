...
const Home = () => {
  ...
  previousBilled.amount = String(
    subsData !== undefined ? `$${(subsData as any)?.plan.amount / 100}` : "$0"
  );
  previousBilled.planName = String(
    subsData !== undefined ? `${subsData?.metadata?.planType}` : "No Plan"
