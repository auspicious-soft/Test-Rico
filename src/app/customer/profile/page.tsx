        ...
        <div className="bg-white rounded-[20px] p-5 md:p-[30px]">
          ...
          <div className="profile-form grid md:flex flex-wrap gap-5 md:gap-[30px]">
            <div className="md:w-[calc(50%-15px)]">
              <label htmlFor="firstName" className="text-[#283c63]">First Name</label>
              <input
                type="text"
                id="firstName"
                name="firstName"
            ...
            <div className="md:w-[calc(50%-15px)]">
              <label htmlFor="lastName" className="text-[#283c63]">Last Name</label>
              <input
                type="text"
                id="lastName"
                name="lastName"
            ...
            <div className="md:w-[calc(50%-20px)]">
              <label htmlFor="email" className="text-[#283c63]">Email Address</label>
              <input
                type="email"
                id="email"
                name="email"
            ...
            <div className="md:w-[calc(20%-20px)]">
              <label htmlFor="dob" className="text-[#283c63]">Date of Birth</label>
              <input
                type="date"
                id="dob"
                name="dob"
            ...
            <div className="md:w-[calc(30%-20px)]">
              <label htmlFor="phoneNumber" className="text-[#283c63]">Phone Number</label>
              <input
                type="text"
                id="phoneNumber"
                name="phoneNumber"
            ...
            <div className="md:w-[calc(60%-20px)]">
              <label htmlFor="address1" className="text-[#283c63]">Home Address</label>
              <input
                type="text"
                id="address1"
                name="address1"
            ...
            <div className="md:w-[calc(20%-20px)]">
              <label htmlFor="city" className="text-[#283c63]">City</label>
              <input
                type="text"
                id="city"
                name="city"
            ...
            <div className="md:w-[calc(20%-20px)]">
              <label htmlFor="state" className="text-[#283c63]">State</label>
              <CustomSelect
