...
import AppointmentLogo from "../components/AppointmentLogo";
  ...
  return (
    <>
      ...
      <div>
       ...
       (
(
  // Show the "No Therapist" UI instead of just a disabled button
    <div className="text-center flex flex-col bg-transparent items-center p-6 rounded-lg">
      {/* Doctor/Therapist Illustration */}
      <div className="mb-4 flex justify-center">
        <AppointmentLogo/>
      </div>
      
      <h3 className="text-lg font-semibold text-[#283C63] mb-2">
        Choose Your Therapist To Get Started!
      </h3>
      <p className="text-sm text-gray-600 mb-4 max-w-md">
        Browse through our trusted professionals, view their specialties, and 
        choose the one who best fits your needs. Your journey to emotional 
        wellness starts here.
      </p>
      <button 
        className="bg-[#283C63] text-white px-6 py-2 rounded-md text-sm hover:bg-[#1f2d4a] transition-colors"
        onClick={() => router.push("/customer/appointments/therapist")}
      >
        Choose Therapist →
      </button>
    </div>
