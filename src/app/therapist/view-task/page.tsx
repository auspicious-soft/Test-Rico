...
//   // Construct dynamic SWR key
//   const swrKey = userId
//     ? `/therapist/tasks/${userId}?page=${currentPage}&limit=${rowsPerPage}&description=${searchQuery}`
//     : null;

//   const { data, error, isLoading, mutate } = useSWR(swrKey, getAllTasksData);
//   const tasksData: any = data?.data?.data;
//   const total = data?.data?.total;
...
//                           ? 'light-color cursor-not-allowed'
//                           : 'text-white'
//                       }`}
